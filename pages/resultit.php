...
echo '
                <p class="text-success" style="font-size: 2rem; text-align: center;">🎉คุณเหมาะกับสาขาเทคโนโลยีสารสนเทศและวิทยาการข้อมูล!🎉</p>
                ...
                echo '<div class="best-match" style="font-size: 16px">เทคโนโลยีสารสนเทศและวิทยาการข้อมูล ' . $itScore .  '%</div>';
                echo '<img src="../public/img/CITE.svg" alt="Profile">';
                echo '</div>';
                echo '<div class="progress mt-2">';
                echo '<div class="progress-bar" role="progressbar" style="width: ' . $itScore . '%;" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>';
                echo '</div>';
